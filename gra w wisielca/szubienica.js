...
function sprawdz(nr){
    ...
    //wygrana
    if(haslo == haslo1)
    document.getElegitmentById("alfabet").innerHTML = "Brawo, odgadłeś hasło ! :"
    +"<br /><br />"+haslo+'<span class="reset" onclick="location.reload()"> JESZCZE RAZ ? </span>';

    //przegrana
    if(ile_skuch>=9)
    document.getElementById("alfabet").innerHTML = "Niestety nie wyszło..."+"<br /><br />"+'<span class="reset" onclick="location.reload()"> JESZCZE RAZ ? </span>';
