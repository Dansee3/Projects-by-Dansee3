...
class Ui {
  ...
  addBookToTable(book) {
    ...
    tr.innerHTML = `
            ...
            <td>${book.author} </td>
            <td>
                <button type="button" data-book-id="${book.id}"         class="btn btn-danger br-sm delete">Delete</button>

                <button type="button" data-book-id="${book.id}"         class="btn btn-secondary br-sm up-arrow">⮝</button>

                <button type="button" data-book-id="${book.id}"         class="btn btn-secondary br-sm down-arrow">⮟</button>
            </td>
        `;
